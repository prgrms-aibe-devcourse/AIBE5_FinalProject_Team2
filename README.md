...
![System Architecture](png/ARCHITECTURE_DIAGRAM.png)
...
![Deployment Topology](png/DEPLOY_DIAGRAM.png)
...
![최종 통합 아키텍처](png/ARCHITECTURE_DIAGRAM.png)
...
![Engine 1 · Quant/IDE 흐름](png/ENGINE_1_QUANT.png)
![Engine 1 · 아키텍처 경로](png/engine1_archi.png)

### ② Analytics 엔진 — Workspace 탭↔AnalyticsClient↔FastAPI 모듈
![Engine 2 · Analytics 흐름](png/ENGINE_2_ANALYTICS.png)
![Engine 2 · 아키텍처 경로](png/engine2_archi.png)

### ③ 매수매도 주문체결 + 결제 엔진 — 9관문·CAS·KIS/Binance·Toss
![Engine 3 · 주문체결/결제 흐름](png/ENGINE_3_ORDER.png)
![Engine 3 · 아키텍처 경로](png/engine3_archi.png)

### ④ Lean 엔진 — EXPERT 게이트→영속 큐→EKS Job→per-job HMAC 콜백
![Engine 4 · Lean 흐름](png/ENGINE_4_LEAN.png)
![Engine 4 · 아키텍처 경로](png/engine4_archi.png)
