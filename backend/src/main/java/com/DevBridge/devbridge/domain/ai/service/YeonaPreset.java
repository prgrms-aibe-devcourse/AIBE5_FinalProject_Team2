...
/**
 * 연아무한매수법 "대표 포트폴리오" — 검증된 strategyConfig 단일 소스(SSOT).
 *
 * <p>실제 사용자(이효연) 5월 실현손익 ₩8,026,367 대비 백테스트 0.88x 재현으로 검증된 파라미터.
 * doFormalize 시스템프롬프트·InfiniteBuyingController.create 분기에 흩어져 있던 연아 상수를
 ...
 */
public final class YeonaPreset {

    private YeonaPreset() {}

    public static final String PRESET_ID = "preset-yeona";
    public static final String STRATEGY_NAME = "연아 무한매수법 (대표 포트폴리오)";

    /**
     * 연아 strategyConfig envelope {candidates:[검증값 1장], selectedId} 생성.
    ...
    public static Map<String, Object> buildEnvelope(Long capitalKrw) {
        ...
        cand.put("rationale",
                "검증된 연아무한매수법 — TQQQ/SOXL 40분할, 평단×1.13 익절(1주 남김), "
