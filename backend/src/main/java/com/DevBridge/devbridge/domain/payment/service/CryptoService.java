...
public class CryptoService {
    ...
    public CryptoService(@Value("${app.crypto.key}") String base64Key) {
        ...
        // dev-only prefix 또는 application.properties의 알려진 기본키(00..1f) 둘 다 dev로 간주
        this.devKey = base64Key.startsWith("dev-only")
                || "AAECAwQFBgcICQoLDA0ODxAREhMUFRYXGBkaGxwdHh8=".equals(base64Key.trim());
    }
